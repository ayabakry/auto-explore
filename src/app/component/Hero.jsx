...
const Hero = () => {
  return (
    <section
      className="relative min-h-[70vh] flex flex-col justify-center overflow-hidden bg-cover bg-center"
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8 text-center">
        ...
        <p className="text-xl text-white/90 mb-12 max-w-2xl mx-auto leading-relaxed">
          Choose from our premium fleet of vehicles. Book instantly or request
          availability for your perfect ride.
        </p>
