...
const Contact = () => {
  ...
  const handleWhatsApp = () => {
    ...
    const whatsappUrl = `https://wa.me/1117110818?text=${encodeURIComponent(message)}`;
      ...
      <section className="py-20 bg-gradient-to-r from-blue-900 via-primary-glow to-yellow-500 text-primary-foreground">
        <div className="container mx-auto px-4 lg:px-8 text-center">
          ...
          <p className="text-xl lg:text-2xl mb-8 max-w-3xl mx-auto opacity-90">
            Get in touch with our friendly team. We're here to help you find the perfect rental car for your needs.
          </p>
          <Button 
            variant="secondary" 
            size="lg" 
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <Card className="shadow-card">
              <CardHeader>
                <CardTitle className="text-3xl text-blue-900 font-bold mt-6">Send us a Message</CardTitle>
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="firstName" type="text" placeholder="ahmed" required />
                  </div>
                  <div className="space-y-2">
                  ...
                  <Button type="submit" variant="default" size="lg" className="w-full bg-blue-900">
                ...
                <CardContent className="p-0">
                  <div className="bg-gradient-to-br from-primary/10 to-accent/10 h-64 rounded-lg flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-muted-foreground">Find our locations near you</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
